...
{
    public partial class frmPensionCaseFile : Form
    {
        ...
        public frmPensionCaseFile()
        {
            InitializeComponent();
        }

        public frmPensionCaseFile(string proj, string bundle, OdbcConnection pCon, Credentials pcrd, DataLayerDefs.Mode mode, eSTATES[] prmState)
        {
            InitializeComponent();
        ...
        public frmPensionCaseFile(string proj, string bundle, OdbcConnection pCon, Credentials pcrd, DataLayerDefs.Mode mode, string file, string stage)
        {
            InitializeComponent();
        ...
        public frmPensionCaseFile(string proj, string bundle, OdbcConnection pCon, Credentials pcrd, DataLayerDefs.Mode mode, string file)
        {
            InitializeComponent();
        ...
        private void frmPensionCaseFile_Load(object sender, EventArgs e)
        {
            if (_mode == Mode._Add)
            {
            ...
            if (_mode == Mode._Edit)
            {
                ...
                string fileid = _GetFileCaseDetailsIndividual(projKey, bundleKey, old_filename).Rows[0][9].ToString();
                string familyPensioer = _GetFileCaseDetailsIndividual(projKey, bundleKey, old_filename).Rows[0][10].ToString();
                string dob = _GetFileCaseDetailsIndividual(projKey, bundleKey, old_filename).Rows[0][11].ToString();
                string doj = _GetFileCaseDetailsIndividual(projKey, bundleKey, old_filename).Rows[0][12].ToString();
                string dod = _GetFileCaseDetailsIndividual(projKey, bundleKey, old_filename).Rows[0][13].ToString();
                string dor = _GetFileCaseDetailsIndividual(projKey, bundleKey, old_filename).Rows[0][14].ToString();
                string psa = _GetFileCaseDetailsIndividual(projKey, bundleKey, old_filename).Rows[0][15].ToString();
                string sec = _GetFileCaseDetailsIndividual(projKey, bundleKey, old_filename).Rows[0][16].ToString();
                string fileno = _GetFileCaseDetailsIndividual(projKey, bundleKey, old_filename).Rows[0][17].ToString();
                string ppo = _GetFileCaseDetailsIndividual(projKey, bundleKey, old_filename).Rows[0][18].ToString();
                string gpo = _GetFileCaseDetailsIndividual(projKey, bundleKey, old_filename).Rows[0][19].ToString();
                string mobile = _GetFileCaseDetailsIndividual(projKey, bundleKey, old_filename).Rows[0][21].ToString();
                string hrms = _GetFileCaseDetailsIndividual(projKey, bundleKey, old_filename).Rows[0][22].ToString();
                string spouce = _GetFileCaseDetailsIndividual(projKey, bundleKey, old_filename).Rows[0][23].ToString();

                deTextBox6.Text = state;
                deTextBox7.Text = emp_name;
                deTextBox8.Text = desg;
                deTextBox9.Text = fileid;
                deTextBox30.Text = familyPensioer;
                ...
                if (dor != "")
                {
                    deTextBox16.Text = dor.Substring(8, 2);
                    deTextBox17.Text = dor.Substring(5, 2);
                    deTextBox18.Text = dor.Substring(0, 4);
                }
                if (dod != "")
                {
                    deTextBox27.Text = dod.Substring(8, 2);
                    deTextBox28.Text = dod.Substring(5, 2);
                    deTextBox29.Text = dod.Substring(0, 4);
                }

                deTextBox19.Text = psa;
                deTextBox20.Text = sec;
                deTextBox21.Text = fileno;
                deTextBox22.Text = ppo;
                deTextBox23.Text = gpo;
                deTextBox24.Text = mobile;
                deTextBox25.Text = hrms;
                deTextBox26.Text = spouce;
        ...
        public bool validate()
        {
            ...
            {
                bool res1 = System.Text.RegularExpressions.Regex.IsMatch(deTextBox24.Text, "^[6-9]{1}[0-9]{1}[0-9]{8}$");
            ...
            string isRDate = deTextBox18.Text + deTextBox17.Text + deTextBox16.Text;
            string isDDate = deTextBox29.Text + deTextBox28.Text + deTextBox27.Text;
            ...
            {
                isBDate = deTextBox12.Text + "-" + deTextBox11.Text + "-" + deTextBox10.Text;
                isDDate = deTextBox29.Text + "-" + deTextBox28.Text + "-" + deTextBox27.Text;
            ...
            {
                isBDate = deTextBox12.Text + "-" + deTextBox11.Text + "-" + deTextBox10.Text;
                isRDate = deTextBox18.Text + "-" + deTextBox17.Text + "-" + deTextBox16.Text;
        ...
        private bool insertIntoMeta(int itemno, string dept, string subCat, string state_name, string filename, string emp_name, string desg, string fileid, string familyPensioner, string bdate, string jdate, string rdate, string dDate, string psa, string section, string file_no, string ppono, string gpo, string mobile, string hrms, string spouce, OdbcTransaction trans)
        {
            bool commitBol = true;
            ...
            if (frmPensionCaseFile.state[0] == eSTATES.METADATA_ENTRY)
            {
                sqlStr = @"insert into metadata_entry(proj_code,batch_key,item_no,department,subcat,state_name,filename,emp_name,desg,fileid,family_pensioner,birth_date,joining_date,death_date,retirement_date,psa_name,section,pension_file_no,ppo_fppo,gpo_dgpo,mobile,hrms_id,spouce,created_by,created_dttm,status) values('" +
                        projKey + "','" + bundleKey + "','" + itemno +
                        "','" + dept + "','" + subCat + "','" + state_name + "','" + filename + "','" + emp_name + "','" + desg + "','" + fileid + "','" + familyPensioner + "','" + bdate + "','" + jdate + "','" + dDate + "','" + rdate + "','" + psa + "','" + section + "','" + file_no + "','" + ppono + "','" + gpo + "','" + mobile + "','" + hrms + "','" + spouce + "','" + crd.created_by + "','" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "',0)";
            ...
            else
            {
                sqlStr = @"insert into metadata_entry(proj_code,batch_key,item_no,department,subcat,state_name,filename,emp_name,desg,fileid,family_pensioner,birth_date,joining_date,death_date,retirement_date,psa_name,section,pension_file_no,ppo_fppo,gpo_dgpo,mobile,hrms_id,spouce,created_by,created_dttm,status) values('" +
                        projKey + "','" + bundleKey + "','" + itemno +
                        "','" + dept + "','" + subCat + "','" + state_name + "','" + filename + "','" + emp_name + "','" + desg + "','" + fileid + "','" + familyPensioner + "','" + bdate + "','" + jdate + "','" + dDate + "','" + rdate + "','" + psa + "','" + section + "','" + file_no + "','" + ppono + "','" + gpo + "','" + mobile + "','" + hrms + "','" + spouce + "','" + crd.created_by + "','" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "',5)";
                //sqlCmd.Connection = sqlCon;
            }
            sqlCmd.Connection = sqlCon;
        ...
        public bool updateMetaEdit(string dept, string subCat, string state_name, string emp_name, string desg, string fileid, string fPensioner, string bdate, string jdate, string rdate, string ddate, string psa, string section, string file_no, string ppono, string gpo, string mobile, string hrms, string spouce)
        {
            bool ret = false;
            if (ret == false)
            {
                _UpdateMetaEdit(projKey, bundleKey, old_filename, filename, dept, subCat, state_name, emp_name, desg, fileid, fPensioner, bdate,
                    jdate, rdate, ddate, psa, section, file_no, ppono, gpo, mobile, hrms, spouce);
        ...
        public bool _UpdateMetaEdit(string projKey, string bundleKey, string oldFileName, string fileName,
            string dept, string subCat, string state_name, string emp_name, string desg, string fileid, string fPensioner, string bdate,
            string jdate, string rdate, string ddate, string psa, string section, string file_no,
            string ppono, string gpo, string mobile, string hrms, string spouce)
        {
            string sqlStr = null;
            ...
            sqlStr = "UPDATE metadata_entry SET filename = '" + fileName + "',department  = '" + dept + "',subcat = '" + subCat + "'," +
                "state_name = '" + state_name + "',emp_name = '" + emp_name + "',desg= '" + desg + "',fileid='" + fileid + "',family_pensioner='" + fPensioner + "'," +
                "birth_date='" + bdate + "',joining_date='" + jdate + "',death_date='" + ddate + "',retirement_date='" + rdate + "',psa_name='" + psa + "',section='" + section + "'," +
                "pension_file_no='" + file_no + "',ppo_fppo='" + ppono + "',gpo_dgpo='" + gpo + "',mobile='" + mobile + "',hrms_id='" + hrms + "'," +
                "spouce='" + spouce + "',modified_by ='" + crd.created_by + "',modified_dttm = '" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "'  WHERE proj_code = '" + projKey + "' AND batch_key = '" + bundleKey + "' and filename = '" + oldFileName + "' ";
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    if (validate() == true)
                    {
                        ...
                        if (checkFileNotExists(filename, dept, subCat) == true)
                        {
                            ...
                            string emp_name = deTextBox7.Text.Trim();
                            string designation = deTextBox8.Text.Trim();
                            string fileid = deTextBox9.Text.Trim();
                            string familyPensioner = deTextBox30.Text.Trim();
                            ...
                            {
                                rDate = deTextBox18.Text + "-" + deTextBox17.Text + "-" + deTextBox16.Text;
                            }
                            else
                            {
                                rDate = "";
                            ...
                            {
                                dDate = deTextBox29.Text + "-" + deTextBox28.Text + "-" + deTextBox27.Text;
                            }
                            else
                            {
                                dDate = "";
                            ...
                            string psaOrag = deTextBox19.Text.Trim();
                            string section = deTextBox20.Text.Trim();


                            string ppo = deTextBox22.Text.Trim();
                            string gpo = deTextBox23.Text.Trim();

                            string mobileNumber = deTextBox24.Text.Trim();
                            string hrms = deTextBox25.Text.Trim();
                            string spouce = deTextBox26.Text.Trim();



                            bool insertCase = insertIntoMeta(item, dept, subCat, statename, filename, emp_name, designation, fileid, familyPensioner, bDate, joinDate, rDate, dDate, psaOrag, section, filenumber, ppo, gpo, mobileNumber, hrms, spouce, sqlTrans);
                            if (insertCase == true)
                            {
                                if (sqlTrans == null)
                                {
                                ...
                                if (frmPensionCaseFile.state[0] == eSTATES.METADATA_ENTRY)
                                {
                                    frmPensionCaseFile_Load(sender, e);
                                }
                                else
                                { this.Close(); }
                            }
            ...
            if (_mode == Mode._Edit)
            {
                if (currStage == "Entry")
                {
                    if (validate() == true)
                    {
                        ...
                        if (deTextBox21.Text.Trim() != Files.filename)
                        {
                            if (checkFileNotExistsEdit(deTextBox21.Text.Trim(), dept, subCat) == true)
                            {
                                casefile = deTextBox21.Text.Trim();
                                ...
                                bool updateMeta = updateMetaEdit(dept, subCat, statename, emp_name, designation, fileid, familyPensioner, bDate, joinDate,
                                 rDate, dDate, psaOrag, section, filenumber, ppo, gpo, mobileNumber, hrms, spouce);
                ...
                if (currStage == "FQC")
                {
                    if (validate() == true)
                    {
                        ...
                        if (deTextBox21.Text.Trim() != aeFQC.filename)
                        {
                            if (checkFileNotExistsEdit(deTextBox21.Text.Trim(), dept, subCat) == true)
                            {
                                casefile = deTextBox21.Text.Trim();
                                ...
                                string designation = deTextBox8.Text.Trim();
                                string fileid = deTextBox9.Text.Trim();
                                string familyP = deTextBox30.Text.Trim();
                                ...
                                bool updateMeta = updateMetaEdit(dept, subCat, statename, emp_name, designation, fileid, familyP, bDate, joinDate,
                                 rDate, dDate, psaOrag, section, filenumber, ppo, gpo, mobileNumber, hrms, spouce);
                                bool updateimageMaster = updateImageEdit();
                                bool updatetransLog = updateTransLogEdit();
                                bool updatecusExc = updateCustExcEdit();
        ...
        private void deTextBox21_Leave(object sender, EventArgs e)
        {
            if (_mode == Mode._Add)
            {
                checkFileNotExists(deTextBox21.Text.Trim(), deTextBox4.Text.Trim(), deTextBox5.Text.Trim());
            }
            if (_mode == Mode._Edit)
            {
                if (currStage == "Entry")
                {
                    if (deTextBox21.Text.Trim() != Files.filename)
                    {
                        checkFileNotExistsEdit(deTextBox21.Text.Trim(), deTextBox4.Text.Trim(), deTextBox5.Text.Trim());
                    }
                }
                if (currStage == "FQC")
                {
        ...
        private void frmPensionCaseFile_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void deTextBox25_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((Regex.IsMatch(e.KeyChar.ToString(), @"^[a-zA-Z0-9\s\b\cC\cX\cV\cA]*$")) || (e.KeyChar.ToString() == "-") || (e.KeyChar.ToString() == "_"))
            {
                e.Handled = false;
        ...
        private void deTextBox26_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((Regex.IsMatch(e.KeyChar.ToString(), @"^[a-zA-Z0-9\s\b\cC\cX\cV\cA]*$")) || (e.KeyChar.ToString() == "-") || (e.KeyChar.ToString() == "_"))
            {
                e.Handled = false;
        ...
        private void deTextBox7_TextChanged(object sender, EventArgs e)
        {
            if ((Regex.IsMatch(deTextBox7.Text.ToString(), @"^[a-zA-Z0-9\s\b\cC\cX\cV\cA]*$")) || (deTextBox7.Text.ToString() == "-") || (deTextBox7.Text.ToString() == "_"))
            {
